...
abstract NativeStringMap<V>(
    ...
    inline public function set(k : String, v : Null<V>) : Void {
        #if js
    ...
    inline public function get(k : String) : Null<V> {
        #if js
    ...
    inline public function remove(k : String) : Void {
        #if js
