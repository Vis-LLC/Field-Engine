...
#if(!EXCLUDE_RENDERING_CONSOLE && !JS_BROWSER)
...
**/
class ANSI extends RendererConsoleAbstract {
    public static var _instance : RendererInterface = new ANSI();
...
/* TODO
    public override function moveCursor(dx:Int, dy:Int) {
        Sys.stdout().writeString("\x1B[" + cursorX + ";" + cursorY + "H");
