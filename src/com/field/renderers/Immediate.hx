...
@:nativeGen
/**
    A Concrete Strategy for how the FieldView runs all rendering operations immediately.
    These functions are not meant to used externally, only internally to the FieldEngine library.
**/
class Immediate implements RendererMode {
    public static var _instance : RendererMode = new Immediate();
