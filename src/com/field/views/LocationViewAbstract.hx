...
**/
class LocationViewAbstract<F, L> extends AbstractView implements com.field.renderers.MouseEventReceiver implements com.field.renderers.TouchEventReceiver implements com.field.Usable<F, L> {
    ...
    private var _hasText : Bool = false;
        ...
        // Intentionally empty
    #else
        private static var _elementToView : NativeObjectMap<LocationViewAbstract<Dynamic, Dynamic>> = new NativeObjectMap<LocationViewAbstract<Dynamic, Dynamic>>();
    #end
    private var _settings : CommonSettings<LocationViewAbstract<Dynamic, Dynamic>>;
    ...
    **/
    public static function getI(lLocation : LocationInterface<Dynamic, Dynamic>, settings : CommonSettings<LocationViewAbstract<Dynamic, Dynamic>>, field : FieldViewAbstract, fixedElement : Element) : LocationViewAbstract<Dynamic, Dynamic> {
        if (lLocation != null) {
            var iElementCount = (settings.tileElement ? 1 : 0) + (settings.effectElement ? 1 : 0) + (settings.selectElement ? 1 : 0) + settings.shellElements;
            var view : Null<LocationViewAbstract<Dynamic, Dynamic>> = null;
    ...
    private static function setLocationView(o : Element, l : LocationViewAbstract<Dynamic, Dynamic>) : Void {
        #if js
    ...
    **/
    public static function toLocationView(o : Element) : LocationViewAbstract<Dynamic, Dynamic> {
        #if js
            var view : LocationViewAbstract<Dynamic, Dynamic> = null;
    ...
    **/
    public function onclick(e : EventInfoInterface) : Void {
        var view : LocationViewAbstract<F, L>;
        #if js
            view = cast toLocationView(cast this);
        #else
            view = cast this;
        #end
    ...
    **/
    ...
    public function init(newField : F, newX : Int, newY : Int) : L {
        return cast this;
    }
}
#end